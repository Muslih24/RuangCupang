												...
												?>
													<tr>
														...
														<td>
															...
															<!-- <a class="btn btn-info btn-sm" href="<?= base_url('Backend/SA/Admin/edit/' . $key->id); ?>">Ubah</a> -->
															<a class="btn btn-danger btn-sm" href="<?= base_url('Backend/SA/Admin/ProsesDeleteAdmin/' . $key->id); ?>">Hapus</a>
														</td>
													</tr>
												<?php } ?>
											</tbody>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="<?= site_url("Backend/SA/Admin/ProsesAddAdmin");?>" method="post">
				...
				<div class="modal fade" id="exampleModalForm2<?php echo $key->id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalFormTitle" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<?= form_open_multipart("Backend/SA/Admin/ProsesEditAdmin")?>
								<!-- <form action="<?= site_url("Backend/SA/Admin/ProsesEditAdmin");?>"> -->
