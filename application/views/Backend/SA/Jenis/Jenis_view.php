                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-danger btn-sm" href="<?= base_url('Backend/SA/Jenis/DeleteJenis/' . $key->id_jenis); ?>">Hapus</a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="<?= site_url("Backend/SA/Jenis/ProsesAddJenis"); ?>" method="post">
                    ...
                    <div class="modal fade" id="exampleModalForm2<?php echo $key->id_jenis; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalFormTitle" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?= form_open_multipart("Backend/SA/Jenis/ProsesEditJenis") ?>
